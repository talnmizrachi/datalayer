...
class V3DailyPulseModel(db.Model):
    ...
    placement_revenue = db.Column(db.Integer, default=0)
    monthly_placements_revenue = db.Column(db.Integer, default=0)
    yearly_placements_revenue = db.Column(db.Integer, default=0)
    quarterly_cumulative_placements = db.Column(db.Integer, default=0)
    quarterly_placements_revenue = db.Column(db.Integer, default=0)
