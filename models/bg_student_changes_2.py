...
class BGStudentChangesModel2(db.Model):
    __tablename__ = 'bg_student_changes_2'
    
    id = db.Column(db.String, primary_key=True, default=lambda: str(uuid4().hex))
    hubspot_id = db.Column(db.String, db.ForeignKey('bg_students_2.hubspot_id'), nullable=False)
