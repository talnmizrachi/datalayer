...
class MarketingGoogleAdsAdPerformanceByDay(db.Model):
    __tablename__ = 'google_ads_ad_performance_by_day'
    
    adgroupad_ad_id = db.Column(db.String, primary_key=True)
    adgroupad_ad_name = db.Column(db.String)
